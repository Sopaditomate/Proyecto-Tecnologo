...
const app = express(); //instancia creada del servidor express
//se configura con middlewares y rutas

const allowedOrigins = ["http://127.0.0.1:53885/", "http://localhost:5173"];
//especificacion de los dominios que pueden hacer peticiones al backend
//en etse caso los puertos del frontend
