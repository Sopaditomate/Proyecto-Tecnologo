...
import { useCart } from "/src/models/CartContext.jsx";
...
export function Header({
  ...
  // Mejorar la estructura de los elementos de navegación para que se oculten progresivamente
  const renderNavLinks = (itemHeader) => {
    if (!itemHeader || itemHeader.length === 0) return null;
