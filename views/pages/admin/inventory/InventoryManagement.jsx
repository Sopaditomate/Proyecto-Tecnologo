...
const InventoryManagement = () => {
  ...
  const fetchInventory = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`${VITE_API_URL}/inventario/`);
  ...
  const fetchUnidades = async () => {
    try {
      const response = await axios.get(
        `${VITE_API_URL}/inventario/unidades`
      );
  ...
  const fetchHistorial = async () => {
    try {
      const response = await axios.get(
        `${VITE_API_URL}/inventario/historial`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        ...
        await axios.post(`${VITE_API_URL}/inventario/nuevo`, {
          nombre: MATERIA_PRIMA,
          tipoMateria: TIPO,
          unidad: UNIDAD,
          cantidad: CANTIDAD,
  ...
  const handleUploadSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${VITE_API_URL}/inventario/cargar`,
        formData,
        {
          headers: {
